...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    /**
     * 关联ViewPager,关联数据支持同时切换fragments
     */
    public void setTabData(ArrayList<CustomTabEntity> tabEntitys, FragmentActivity fa, ViewPager vp, ArrayList<Fragment> fragments) {
        if (vp == null) {
            throw new IllegalStateException("ViewPager can not be NULL !");
        }
        vp.setAdapter(new MyPagerAdapter(fa.getSupportFragmentManager(), tabEntitys, fragments));
//        vp.setOffscreenPageLimit(fragments.size());
    ...
    private class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        public MyPagerAdapter(FragmentManager fm, ArrayList<CustomTabEntity> tabEntitys, ArrayList<Fragment> fragments) {
            super(fm);
            this.tabEntitys = tabEntitys;
            this.fragments = fragments;
        }

        @Override
        public int getCount() {
            return tabEntitys.size();
        }

        @Override
        public CharSequence getPageTitle(int position) {
            return tabEntitys.get(position).getTabTitle();
        }
